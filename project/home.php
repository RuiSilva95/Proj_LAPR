                    ...
                    <div class="col-lg-12">
                        <form method="POST" name="filterInternal" class="form-inline" action="<?php echo current_file(); ?>">
                            ...
                            <div class="col-lg-3 form-group">
                                ...
                                <input type="text" name="numberid1" class="form-control" id="NumberId" value="<?php echo $_POST['numberid']; ?>"  />
                            </div>
                                ...
                                <table class="table table-hover table-striped">
                                    ...
                                    <tbody>
                                        ...
                                        if($_POST['employee']!=0) {
                                            ...
                                            $query = 'SELECT * FROM external e, intern';
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <form method="POST" name="filterExternal" class="form-inline" action="<?php echo current_file(); ?>">
                            ...
                            <div class="col-lg-3 form-group">
                                <label for="NumberId">Number ID</label>
                                <input type="text" name="numberid2" class="form-control" id="NumberId" value="<?php echo $_POST['numberid']; ?>"  />
                            </div>
                                ...
                                <table class="table table-hover table-striped">
                                    ...
                                    <tbody>
                                        ...
                                        $query = 'SELECT * FROM external
                                                            ...
                                                            WHERE  ORDER BY external.id DESC';
